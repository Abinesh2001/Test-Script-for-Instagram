...
public class ShareThePost 
{
  ...
  public void share() throws InterruptedException 
  {
	  ...
	  JavascriptExecutor js = (JavascriptExecutor) driver;
	   ...
	   Thread.sleep(3000);
	   driver.findElement(By.xpath("//body/div[@id='react-root']/section[1]/main[1]/section[1]/div[1]/div[3]/div[1]/article[1]/div[1]/div[3]/div[1]/div[1]/section[1]/span[3]/button[1]")).click();
	   WebElement search=driver.findElement(By.name("queryBox"));
