...
public class LikeAPicture 
{
  ...
  public void clickonlike() 
  {
	...
	//   driver.findElement(By.xpath("/html/body/div[5]/div/div/div/div[3]/button[2]")).click();
	  ...
	  driver.findElement(By.xpath("//body/div[@id='react-root']/section[1]/main[1]/section[1]/div[1]/div[3]/div[1]/div[1]/article[1]/div[1]/div[3]/div[1]/div[1]/section[1]/span[1]/button[1]")).click();
  }
  @BeforeTest
