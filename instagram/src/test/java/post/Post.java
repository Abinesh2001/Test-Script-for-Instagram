...
public class Post 
{
  ...
  public void uploadthepicture() 
  {
	...
	//  driver.findElement(By.xpath("/html/body/div[5]/div/div/div/div[3]/button[2]")).click();  
	  ...
	  driver.findElement(By.xpath("//body/div[@id='react-root']/section[1]/nav[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[3]/div[1]/button[1]/div[1]/*[1]")).click();
	   WebElement upload= driver.findElement(By.xpath("//button[contains(text(),'Select from computer')]"));
	 //  upload.click();
	   upload.sendKeys("C:\\Users\\atcha\\OneDrive\\Desktop\\new1.png");
